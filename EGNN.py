...
# from models.gcl import E_GCL_vel
# from functions_utils import unsorted_segment_mean, unsorted_segment_sum
...
class EGNN_vel(nn.Module):
    def __init__(
        ...
        self.vel_predictor = nn.Linear(self.hidden_nf, 2)  # Predicting 2D velocities
    ...
    def forward(self, h, x, edges, vel, edge_attr):
        ...
        vel_pred = self.vel_predictor(
            h
        )  # Predicting velocities from the final node embeddings
        return x, vel_pred
